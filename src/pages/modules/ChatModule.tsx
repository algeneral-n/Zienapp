    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className={`w-80 border-r border-zinc-200 dark:border-zinc-800 flex flex-col ${
          !showMobileList && selectedChannel ? 'hidden md:flex' : 'flex'
            ...
            {filteredChannels.length === 0 ? (
              ...
              filteredChannels.map(ch => (
                <button
                  ...
                  className={`w-full px-4 py-3 flex items-start gap-3 text-left transition-all hover:bg-zinc-50 dark:hover:bg-zinc-800 ${
