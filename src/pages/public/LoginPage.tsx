...
export default function LoginPage({ onLogin }: { onLogin: (user: any) => void }) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Hardcoded bypass for founder testing
    if (identifier.toLowerCase() === 'gm@zien-ai.app' && password === 'Founder123!') {
      onLogin({
        id: 'founder-test-id',
          ...
          >
            <div className="text-center mb-8">
              <div className="relative inline-block mb-6">
                <div className="absolute inset-0 bg-brand blur-3xl opacity-20 animate-pulse"></div>
                <img 
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-black/5 border border-[var(--border-soft)] p-4 pl-12 rounded-xl outline-none focus:ring-2 focus:ring-brand"
          ...
          >
            ...
            <div>
              ...
              <input 
                ...
                className="w-full bg-black/5 border border-[var(--border-soft)] p-4 rounded-xl outline-none focus:ring-2 focus:ring-brand text-center text-2xl tracking-[1em]"
                maxLength={6}
                required
              />
            </div>
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-[var(--bg-primary)] px-4 sm:px-6 py-10 relative overflow-hidden">
