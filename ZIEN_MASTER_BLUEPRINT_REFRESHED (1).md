...
- AI: RARE AI Agents
- Billing: Stripe + إضافات لاحقة
- Provisioning Engine: إنشاء خدمات وموديولات حسب نوع الشركة

### الثوابت
1. عزل كامل Multi-Tenant
2. عزل كامل Roles داخل الشركة
3. ترجمة احترافية 15 لغة
4. RARE AI زر عائم + صفحة مركزية
5. التسعير ديناميكي بعد البروفيجنينج
6. البروفيجنينج هو قلب المنصة
...
## 9) صفحات الويب (المطلوب النهائي)

### 9.1 Public Pages
1. **Landing /**  
   Hero قوي + زر سجل الآن + Header (لوغو أكبر) + Footer + RARE AI
2. **Register /register**  
